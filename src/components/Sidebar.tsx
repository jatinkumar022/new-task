...
const Sidebar = () => {
  return (
    <>
      <div className=" hidden  text-white bg-card-bg w-[20%] lg:w-[18%] rounded-2xl border-2 border-card-border md:flex flex-col justify-between">
      ...
      <div className="md:hidden absolute p-2 bottom-0 left-0 bg-card-bg w-full flex  items-center justify-around  ">
        <NavLink
          to={"all-tasks"}
          className={({ isActive }) =>
            isActive
              ? "flex justify-center items-center rounded-md gap-4 text-xl p-3 duration-300 bg-task-color text-icons-color"
              : "flex justify-center items-center  rounded-md  gap-4 text-xl p-3 duration-300 hover:bg-task-color hover:text-icons-color"
          }
        >
          <TiHome className="text-2xl " />
          <h3 className=" md:block hidden">All Tasks</h3>
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "flex justify-center items-center gap-4  rounded-md  text-xl p-3 duration-300 bg-task-color text-icons-color"
              : "flex justify-center items-center gap-4   rounded-md  text-xl p-3 duration-300 hover:bg-task-color hover:text-icons-color"
          }
        >
          <FaTasks className="text-2xl" />
          <h3 className=" md:block hidden ">Important!</h3>
